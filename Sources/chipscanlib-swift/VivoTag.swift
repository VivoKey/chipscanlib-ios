...
public class VivoTag {
    ...
    public init(tag: NFCISO7816Tag, sub: Int) {
        ...
        if(subtype == VivoTag.NTAG4XX) {
            ...
            part1APDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA9, p1Parameter: 0xA3, p2Parameter: 0x00, data: Data(), expectedResponseLength: 256)
            selAPDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA4, p1Parameter: 0x04, p2Parameter: 0x00, data: Data([0xA0, 0x00, 0x00, 0x07, 0x47, 0x00, 0xCC, 0x68, 0xE8, 0x8C, 0x01]), expectedResponseLength: 256)
    ...
    public func authPart2(pcdResp: String, completion: @escaping (String) -> Void) -> Void {
        ...
        if(subtype == VivoTag.NTAG4XX) {
            // NTAG
            part2APDU = NFCISO7816APDU(instructionClass: 0x90, instructionCode: 0xAF, p1Parameter: 0x00, p2Parameter: 0x00, data: VivoTag.dataWithHexString(hex: pcdResp), expectedResponseLength: 256)
            // Actually send
            ...
            let issuerAPDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA1, p1Parameter: 0x00, p2Parameter: 0x00, data: issuerResp, expectedResponseLength: 256)
            part2APDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA3, p1Parameter: 0x00, p2Parameter: 0x00, data: challResp, expectedResponseLength: 256)
            // Validate the issuer
