...
public class VivoTag {
    ...
    public func authPart2(pcdResp: String, completion: @escaping (String) -> Void) -> Void {
        ...
        if(subtype == VivoTag.NTAG4XX) {
            ...
            let issuerAPDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA1, p1Parameter: 0x00, p2Parameter: 0x00, data: issuerResp, expectedResponseLength: 255)
            part2APDU = NFCISO7816APDU(instructionClass: 0x00, instructionCode: 0xA3, p1Parameter: 0x00, p2Parameter: 0x00, data: challResp, expectedResponseLength: 255)
            // Validate the issuer
